...
#[test]
fn test_shipping_rules_loading() {
    ...
    let report4 = engine.sanitize_prompt(input4, None).unwrap();
    ...
    let report5 = engine.sanitize_prompt(input5, None).unwrap();
