...
use iw_core::{
    EnforcementAction, PiiCategory, PiiShield, Redaction, ScrubbingReport, SessionContext,
    SovereignError, TokenMap,
};
use regex::Regex;
...
impl PiiShield for AhoCorasickShield {
    async fn sanitize_prompt(
        ...
        crate::normalize::Normalizer::with_normalized(prompt, |norm_res| {
